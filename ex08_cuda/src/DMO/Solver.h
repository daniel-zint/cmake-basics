...
namespace DMO
{
	...
	void dmoGPU( thrust::device_vector<float2>& points_d, DmoMesh<true>& dmoMesh1_, const MetricT& metric );
	...
	public:
		Solver<MeshT, MetricT, Metric2T>( MeshT& mesh, MetricT* metric1, DmoMesh<true>* dmoMesh1, Metric2T* metric2 = nullptr, DmoMesh<true>* dmoMesh2 = nullptr );
	...
	*/
	...
	template<typename MeshT, typename MetricT, typename Metric2T>
	void Solver<MeshT, MetricT, Metric2T>::solve( int nIterations ) {
